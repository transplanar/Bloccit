class Api::V1::BaseController < ApplicationController
  ...
  def malformed_request
    render json: {error: "Request could not be understood by the server due to malformed syntax. THe client SHOULD NOT repeat the request without modifications.", status: 400}, status: 400
  end
