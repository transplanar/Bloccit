...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe 'POST create' do
    ...
    it 'assigns new SponsoredPost to @sponsored_post' do
  ...
  describe 'PUT update' do
    ...
    it 'redirects to the updated sponsored_post' do
      ...
      put :update, topic_id: my_topic.id, id: my_sponsored_post.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 1000 }
